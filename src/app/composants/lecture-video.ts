...
@Component({
  ...
  template: `
    <div class="min-h-screen bg-[#050505] text-white flex flex-col">
      <header class="p-6 flex items-center justify-between border-b border-white/5 bg-black/40 backdrop-blur-md sticky top-0 z-50">
        <div class="flex items-center gap-6">
          ...
          <div>
            ...
            <p class="text-xs text-zinc-500 uppercase tracking-widest font-black">Lecteur Cinésphère</p>
          </div>
        </div>
      ...
      <main class="flex-1 flex flex-col lg:flex-row gap-8 p-4 md:p-8 max-w-screen-2xl mx-auto w-full">
          ...
          <div class="mt-8 space-y-6">
            ...
            <div class="p-6 bg-white/5 rounded-2xl border border-white/10">
               <div class="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    <p class="font-bold">Cinésphère Trailers</p>
        ...
        <!-- Sidebar / Suggestions (Statique pour le moment) -->
              ...
              @for (i of [1,2,3,4,5]; track i) {
                <div class="flex gap-4 group cursor-pointer">
                   <div class="w-40 aspect-video rounded-xl bg-zinc-900 border border-white/5 overflow-hidden shrink-0">
                      <div class="w-full h-full bg-gradient-to-br from-zinc-800 to-zinc-900 animate-pulse"></div>
                   </div>
                   <div class="flex flex-col justify-center">
                      <h4 class="text-sm font-bold line-clamp-2 group-hover:text-red-500 transition-colors">Prochaine bande-annonce à découvrir</h4>
                      <p class="text-[10px] text-zinc-500 mt-1 uppercase font-bold">Cinésphère • 2026</p>
                   </div>
                </div>
              }
           </div>
